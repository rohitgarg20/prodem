  ...
  return <View style={styles.container}>
    ...
    <ScrollView contentContainerStyle={styles.mainContainer}>
      <View style={styles.infoCard}>
        <LabelComponent keyLabel={NAME_LABEL} valueLabel={userDetails?.p_user_name} />
        <LabelComponent keyLabel={ADDRESS_LABEL} valueLabel={userDetails?.p_user_address} />
        <LabelComponent keyLabel={BANK_LABEL} valueLabel={userDetails?.p_user_bank} />
        <LabelComponent keyLabel={COMPANY_LABEL} valueLabel={userDetails?.p_user_company_name} />
        <LabelComponent keyLabel={LAST_LOGIN_LABEL} valueLabel={userDetails?.p_user_lastlogin} />
        <LabelComponent keyLabel={TAX_CODE_LABEL} valueLabel={userDetails?.p_user_tax_registration_code} />
      </View>
